<template>
	<div id="agreement">
		<mt-header title="期货融资合作协议" fixed style="background-color:#242933;font-size: 0.32rem;height: 1rem;border-bottom: 1px solid #12141a;line-height: 1rem;">
		  	<router-link to="/tradeLogin/tradeApply" slot="left">
		    	<i id="back"></i>
		  	</router-link>
		</mt-header>
		<div class="page_cont">
			<h3 id="newstitle">融资方案委托协议</h3>
			...
			<p>3、丙方系本APP（下称“丙方应用”或“指数天下”）的运营商，丙方具有应用运营及技术服务优势，可使乙方通过丙方应用申请提供前述服务。</p>
